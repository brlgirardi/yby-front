...
export const MERCHANT_ONBOARDING_RECORDS: Record<string, MerchantOnboardingRecord> = {
  'MCH-001': {
    ...
    terminais: {
      cp: [
        { id: 't1', identificacao: '928132 - Loja', vinculos: [{ id: 'v1', adquirenteId: 'cielo', tid: '2938138' }, { id: 'v2', adquirenteId: 'rede', tid: '231321312' }] },
      ],
      cnp: [],
    },
  },
  'MCH-002': {
    ...
    terminais: {
      cp: [
        { id: 't1', identificacao: '510023 - Matriz', vinculos: [{ id: 'v1', adquirenteId: 'cielo', tid: '5500001' }] },
        { id: 't2', identificacao: '510024 - Filial Centro', vinculos: [{ id: 'v1', adquirenteId: 'stone', tid: '5500102' }] },
      ],
      cnp: [
        { id: 't3', identificacao: 'gateway-checkout-01', vinculos: [{ id: 'v1', adquirenteId: 'pagseguro', tid: 'GW55501' }] },
      ],
    },
  },
  'MCH-003': {
    ...
    terminais: {
      cp: [],
      cnp: [
        { id: 't1', identificacao: 'gateway-ifood', vinculos: [{ id: 'v1', adquirenteId: 'getnet', tid: 'GW3330001' }, { id: 'v2', adquirenteId: 'pagseguro', tid: 'GW3330002' }] },
      ],
    },
  },
}
