...
export function exportOverviewToCSV(brands: BrandData[], date: string): void {
  ...
  const rows = brands.map(b => [
    ...
    b.transactions.reconciled,
    b.transactions.divergent,
    b.transactions.pending,
    formatCurrency(b.tpv.reconciled),
    formatCurrency(b.tpv.divergent),
    formatCurrency(b.tpv.pending),
    formatCurrency(b.itc.reconciled),
    formatCurrency(b.itc.divergent),
    formatCurrency(b.itc.pending),
  ])
